...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="currency_exchange">
        ...
        <div class="exchange_rate">
          <!-- skrypt2: pobieranie wartości z pól i obliczanie wartości po przewalutowaniu wartości kwoty -->
          <?php 
        ...
        <!-- elementy wyświetlające aktualny kurs walut na stronie  -->
      </div>
    <div class="currency_rate">
      <div class="CurrencyCard1">
        <div class="cardbody">
          <!-- skrypt3: pobieranie wartości z pliku XML z strony NBP.api.pl i wyświetalnie ich na stronie -->
          <?php
            $context  = stream_context_create(array('http' => array('header' => 'Accept: application/xml')));
            $url = 'http://api.nbp.pl/api/exchangerates/rates/A/USD';
            $xml = file_get_contents($url, false, $context);
